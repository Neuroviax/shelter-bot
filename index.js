...
⚠️ Обратите внимание: информация предоставляется в справочных целях. Перед походом в укрытие убедитесь в его доступности на месте.`;
  ...
  const captionHe = `👋 שלום! אני בוט שיעזור לך למצוא את המקלט הקרוב ביותר ציון 🛡.

📍 שלחו לי את המקום שלכם – ואחזיר את שלושת המקלטים הקרובים ביותר עם כתובות ומפה.

🔄 הנתונים מתעדכנים באופן שוטף הבוט פועל אוטונומית וזמין 24/7.

⚠️ שימו לב: המידע הוא לצורך הנחיות בלבד. ודאו בשטח שהמקלט פתוח ונגיש.`;
